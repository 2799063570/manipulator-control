...
class Metaclass_JointStateCommand(type):
    """Metaclass of message 'JointStateCommand'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'robot_control_ros2.msg.JointStateCommand')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__joint_state_command
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__joint_state_command
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__joint_state_command
            cls._TYPE_SUPPORT = module.type_support_msg__msg__joint_state_command
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__joint_state_command
...
class JointStateCommand(metaclass=Metaclass_JointStateCommand):
    """Message class 'JointStateCommand'."""
    ...
    def __init__(self, **kwargs):
        ...
        self.is_exc = kwargs.get('is_exc', bool())
    ...
    @builtins.property
    def is_exc(self):
        """Message field 'is_exc'."""
        return self._is_exc

    @is_exc.setter
    def is_exc(self, value):
        if self._check_fields:
            assert \
                isinstance(value, bool), \
                "The 'is_exc' field must be of type 'bool'"
        self._is_exc = value
