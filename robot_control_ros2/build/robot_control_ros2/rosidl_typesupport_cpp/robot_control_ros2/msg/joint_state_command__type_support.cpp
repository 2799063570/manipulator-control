...
static const _JointStateCommand_type_support_symbol_names_t _JointStateCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_control_ros2, msg, JointStateCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robot_control_ros2, msg, JointStateCommand)),
  }
};
...
{
  return &::robot_control_ros2::msg::rosidl_typesupport_cpp::JointStateCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, robot_control_ros2, msg, JointStateCommand)() {
  return get_message_type_support_handle<robot_control_ros2::msg::JointStateCommand>();
}
