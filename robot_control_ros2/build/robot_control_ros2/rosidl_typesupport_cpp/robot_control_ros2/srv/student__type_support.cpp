...
static const _Student_Request_type_support_symbol_names_t _Student_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_control_ros2, srv, Student_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robot_control_ros2, srv, Student_Request)),
  }
};
...
{
  return &::robot_control_ros2::srv::rosidl_typesupport_cpp::Student_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, robot_control_ros2, srv, Student_Request)() {
  return get_message_type_support_handle<robot_control_ros2::srv::Student_Request>();
}
...
static const _Student_Response_type_support_symbol_names_t _Student_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_control_ros2, srv, Student_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robot_control_ros2, srv, Student_Response)),
  }
};
...
{
  return &::robot_control_ros2::srv::rosidl_typesupport_cpp::Student_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, robot_control_ros2, srv, Student_Response)() {
  return get_message_type_support_handle<robot_control_ros2::srv::Student_Response>();
}
...
static const _Student_Event_type_support_symbol_names_t _Student_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_control_ros2, srv, Student_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robot_control_ros2, srv, Student_Event)),
  }
};
...
{
  return &::robot_control_ros2::srv::rosidl_typesupport_cpp::Student_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, robot_control_ros2, srv, Student_Event)() {
  return get_message_type_support_handle<robot_control_ros2::srv::Student_Event>();
}
...
static const _Student_type_support_symbol_names_t _Student_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_control_ros2, srv, Student)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robot_control_ros2, srv, Student)),
  }
};
...
static const rosidl_service_type_support_t Student_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<robot_control_ros2::srv::Student_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<robot_control_ros2::srv::Student_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<robot_control_ros2::srv::Student_Event>(),
...
{
  return &::robot_control_ros2::srv::rosidl_typesupport_cpp::Student_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, robot_control_ros2, srv, Student)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<robot_control_ros2::srv::Student>();
}
