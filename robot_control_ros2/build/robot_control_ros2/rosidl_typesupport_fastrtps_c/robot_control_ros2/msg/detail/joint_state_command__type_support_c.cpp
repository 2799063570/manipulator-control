...
#include "robot_control_ros2/msg/detail/joint_state_command__rosidl_typesupport_fastrtps_c.h"
...
using _JointStateCommand__ros_msg_type = robot_control_ros2__msg__JointStateCommand;
...
{
  const _JointStateCommand__ros_msg_type * ros_message = static_cast<const _JointStateCommand__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robot_control_ros2__msg__JointStateCommand;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const robot_control_ros2__msg__JointStateCommand * ros_message = static_cast<const robot_control_ros2__msg__JointStateCommand *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_robot_control_ros2__msg__JointStateCommand(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  robot_control_ros2__msg__JointStateCommand * ros_message = static_cast<robot_control_ros2__msg__JointStateCommand *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_robot_control_ros2__msg__JointStateCommand(cdr, ros_message);
}

static uint32_t _JointStateCommand__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robot_control_ros2__msg__JointStateCommand(
...
static size_t _JointStateCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robot_control_ros2__msg__JointStateCommand(
...
static message_type_support_callbacks_t __callbacks_JointStateCommand = {
...
static rosidl_message_type_support_t _JointStateCommand__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_JointStateCommand,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_control_ros2, msg, JointStateCommand)() {
  return &_JointStateCommand__type_support;
}
