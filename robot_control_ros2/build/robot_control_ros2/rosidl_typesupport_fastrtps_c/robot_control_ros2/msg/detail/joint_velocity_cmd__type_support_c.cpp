...
#include "robot_control_ros2/msg/detail/joint_velocity_cmd__rosidl_typesupport_fastrtps_c.h"
...
using _JointVelocityCmd__ros_msg_type = robot_control_ros2__msg__JointVelocityCmd;
...
{
  // Field name: velocity_cmd
  {
    size_t size = 6;
    auto array_ptr = ros_message->velocity_cmd;
...
{
  const _JointVelocityCmd__ros_msg_type * ros_message = static_cast<const _JointVelocityCmd__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robot_control_ros2__msg__JointVelocityCmd;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const robot_control_ros2__msg__JointVelocityCmd * ros_message = static_cast<const robot_control_ros2__msg__JointVelocityCmd *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_robot_control_ros2__msg__JointVelocityCmd(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  robot_control_ros2__msg__JointVelocityCmd * ros_message = static_cast<robot_control_ros2__msg__JointVelocityCmd *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_robot_control_ros2__msg__JointVelocityCmd(cdr, ros_message);
}

static uint32_t _JointVelocityCmd__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robot_control_ros2__msg__JointVelocityCmd(
...
static size_t _JointVelocityCmd__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robot_control_ros2__msg__JointVelocityCmd(
...
static message_type_support_callbacks_t __callbacks_JointVelocityCmd = {
...
static rosidl_message_type_support_t _JointVelocityCmd__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_JointVelocityCmd,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_control_ros2, msg, JointVelocityCmd)() {
  return &_JointVelocityCmd__type_support;
}
