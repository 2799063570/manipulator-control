...
bool robot_control_ros2__msg__joint_state_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robot_control_ros2.msg._joint_state_command.JointStateCommand", full_classname_dest, 61) == 0);
  }
  robot_control_ros2__msg__JointStateCommand * ros_message = _ros_message;
  {  // position
  ...
  {  // is_exc
    PyObject * field = PyObject_GetAttrString(_pymsg, "is_exc");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->is_exc = (Py_True == field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of JointStateCommand */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("robot_control_ros2.msg._joint_state_command");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "JointStateCommand");
  ...
  {  // is_exc
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->is_exc ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "is_exc", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
